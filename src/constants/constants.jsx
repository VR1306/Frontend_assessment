export const CONSTANTS = {
  ...
  login_label: 'Login',
  device_information: 'Turn your devices into kiosks in a few minutes with Hexnode UEM',
  start_label: 'Get Started Now!',
  ...
  specifics_header: 'Specific kiosk modes for unique use cases',
  single_app_kisok: 'Single App Kiosk',
  multi_app_kisok: 'Multi-App Kiosk',
  web_based_kisok: 'Web Based Kiosk',
  digital_signages: 'Digital Signages',
  asam_kisok: 'ASAM Kisok',
  single_app_data: {
